...
echo "⚙️ Gerando o token do dashboard.../n" 
...
kubectl port-forward -n kube-system pod/$CADVISOR_POD 8080:8080 > /dev/null 2>&1 &
PF_PID=$!
...
nohup microk8s kubectl port-forward --address 0.0.0.0 -n kube-system service/kubernetes-dashboard 10443:443 
